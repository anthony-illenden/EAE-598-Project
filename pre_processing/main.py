...
def save_to_csv(ds_point, year, month, day, label, output_file="test_all_events.csv"):
...
def main():
    ...
    for event in events:
        ...
        if data_mode == "local":
            ...
            save_to_csv(ds_point_time, year, month, day, label, output_file="test_all_events.csv")
