...
2. Download the data yourself and generate the area-averaged CSV data by running [main.py](scripts_and_notebooks/scripts/main.py), but be sure to change the data_mode to "download". Fair waring—this script will take a long time to run, which is why the first method is the suggested method. 
